...
class TourneyReport(object):
    def __init__(self):
        ...
        self.tourneyReportName = rpt.reportSeason + '-Week-' + str(rpt.tourneyRecord.TourneyNumber) + '-TourneyReport.pdf'
        self.reportTitle = 'LOCAL TOURNAMENT REPORT No:'
